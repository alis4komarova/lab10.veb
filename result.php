...
<body>
    ...
    function test_it($text) {
        ...
        $total_word_count = 0;      // ОБЩЕЕ количество слов в тексте
        ...
        echo '<tr><td>Количество слов</td><td>' . $total_word_count . '</td></tr>';
        echo '</table>';
        
        // количество вхождений каждого символа текста
        ...
        // все слов и количество их вхождений (по алфавиту)
        asort($words); // сортируем массив слов по алфавиту
